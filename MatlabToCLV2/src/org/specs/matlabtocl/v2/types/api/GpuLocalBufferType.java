...
public class GpuLocalBufferType extends AVariableType {
    public GpuLocalBufferType() {
    }
    ...
    @Override
    public Code code() {
	return new GpuLocalBufferCode(this);
    }

    @Override
    public boolean strictEquals(VariableType type) {
	return type instanceof GpuLocalBufferType;
    }
}
