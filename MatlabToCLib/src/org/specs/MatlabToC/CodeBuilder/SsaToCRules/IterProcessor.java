...
public class IterProcessor implements SsaToCRule {
	...
	// *Probably* nothing is needed here, because of findInductionVariable.
	// But if more than one variable gets the iter, then we're in trouble.
	// FIXME: We'll hope for the best for now.
    }
