...
package org.specs.MatlabToC.Program.Global;
...
/**
 * Setup definition for program MatToMatVerifier.
 * 
 * @author Joao Bispo
 */
public enum MatlabToCGlobalSetup implements SetupFieldEnum {
     ...
     * @return
     */
    public static MatlabToCGlobalData getData() {
	...
	return new MatlabToCGlobalData(baseInputFolder, baseOutputFolder);
    }

    private MatlabToCGlobalSetup(FieldType fieldType) {
