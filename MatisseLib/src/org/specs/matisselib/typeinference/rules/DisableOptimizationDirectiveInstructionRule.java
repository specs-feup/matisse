...
public class DisableOptimizationDirectiveInstructionRule implements TypeInferenceRule {

    @Override
    public boolean accepts(SsaInstruction instruction) {
        return instruction instanceof DisableOptimizationDirectiveInstruction;
    }
    ...
    public void inferTypes(TypeInferenceContext context, InstructionLocation location, SsaInstruction instruction) {
        ...
        context.addFunctionProperty(new DisableOptimizationProperty(
                ((DisableOptimizationDirectiveInstruction) instruction).getOptimization()));
    }
