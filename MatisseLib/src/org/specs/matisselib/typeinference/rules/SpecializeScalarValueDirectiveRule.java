...
public class SpecializeScalarValueDirectiveRule implements TypeInferenceRule {

    @Override
    public boolean accepts(SsaInstruction instruction) {
	return instruction instanceof SpecializeScalarValueDirectiveInstruction;
    }
	...
	SpecializeScalarValueDirectiveInstruction specialization = (SpecializeScalarValueDirectiveInstruction) instruction;

	context.pushInstructionRemoval(location);
	context.addValueSpecialization(specialization.getVariableName());
    }
