...
package org.specs.matisselib.tests.ast.matrixreplacement;
...
public class MatrixReplacementTests {
    @Test
    public void testRow() {
        test(MatrixReplacementResource.ROW);
    }

    @Test
    public void testCol() {
        test(MatrixReplacementResource.COL);
    }

    @Test
    public void testMulti() {
        test(MatrixReplacementResource.MULTI);
    }

    @Test
    public void testEmpty1() {
        test(MatrixReplacementResource.EMPTY1);
    }

    @Test
    public void testEmpty2() {
        test(MatrixReplacementResource.EMPTY2);
    }

    private static void test(MatrixReplacementResource resource) {
        ...
        String obtained = new MatrixReplacementPass().apply(parser.parse(resource), passData).getCode();
