...
public final class ComputationBuilderResult {
    private final String resultVariable;
    private final BlockEditorHelper endBuilder;

    public ComputationBuilderResult(String resultVariable, BlockEditorHelper endBuilder) {
	Preconditions.checkArgument(resultVariable != null);
