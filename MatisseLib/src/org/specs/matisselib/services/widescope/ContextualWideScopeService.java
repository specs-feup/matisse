...
public final class ContextualWideScopeService implements WideScopeService {

    private final WideScopeService parentService;
    private final FunctionIdentification context;

    ContextualWideScopeService(WideScopeService parentService, FunctionIdentification context) {
	Preconditions.checkArgument(parentService != null);
	...
	return parentService.getUserFunction(context, name);
    }
	...
	return parentService.getFunctionNode(functionIdentification);
    }
	...
	return new ContextualWideScopeService(parentService, functionIdentification);
    }
