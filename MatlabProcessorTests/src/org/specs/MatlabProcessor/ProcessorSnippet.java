...
public class ProcessorSnippet {

    // @Test
    public void aTest() {
	File mFile = new File("C:\\Users\\JoaoBispo\\Desktop\\lara_test\\test.m");

	FileNode fileNode = new MatlabParser().parse(mFile);

	fileNode.getDescendantsStream()
		.filter(node -> node instanceof ForSt)
		.forEach(forSt -> System.out.println(((ForSt) forSt).getBodyStatements()));
    }
    /**
     * On Core2Quad: <br>
