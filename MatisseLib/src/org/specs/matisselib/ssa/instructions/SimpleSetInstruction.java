...
/**
 * <p>
 * A more constrained version of {@link MatrixSetInstruction}.
 * <p>
 * A matrix set is simple if all its indices are scalars numbers (not logicals), the assigned value is a scalar, and the
 * indices are all integers within range.
 * 
 * @author Luís Reis
 *
 */
public class SimpleSetInstruction extends IndexedInstruction {
    ...
    public SimpleSetInstruction(String outputMatrix, String inputMatrix, List<String> indices, String value) {
    ...
    @Override
    public SimpleSetInstruction copy() {
        return new SimpleSetInstruction(this.outputMatrix, this.inputMatrix, this.indices, this.value);
    }
    ...
    public String toString() {
        return this.outputMatrix + " = simple_set " +
                this.inputMatrix + ", " +
