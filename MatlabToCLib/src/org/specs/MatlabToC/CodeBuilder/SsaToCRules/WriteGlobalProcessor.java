...
public class WriteGlobalProcessor implements SsaToCRule {
    ...
    public void apply(SsaToCBuilderService builder, CInstructionList currentBlock, SsaInstruction instruction) {
        ...
        String global = writeGlobal.getGlobal();
        String input = writeGlobal.getSsaVariable();

        builder.generateAssignmentForSsaNames(currentBlock, global, input);
    }
