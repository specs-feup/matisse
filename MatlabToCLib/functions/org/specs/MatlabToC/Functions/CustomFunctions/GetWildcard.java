...
public class GetWildcard {
     ...
     * @return
     */
    public static FunctionInstance newGetWildcard(Collection<Integer> indexesWithColon, int totalIndexes,
            ProviderData data) {

        // Add M file to the engine
        String functionName = addGetWildcard(indexesWithColon, totalIndexes,
     ...
     */
    public static String addGetWildcard(Collection<Integer> indexesWithColon, int totalIndexes,
    ...
    private static String getMatlabCode(Collection<Integer> indexesWithColon, int totalIndexes,
        ...
        String code = SpecsIo.getResource(BuiltinTemplate.GET_WILDCARD);
        ...
        */
        ...
        // Add function
        AccessMatrixValues accessMatrixTemplate = new AccessMatrixValues(totalIndexes);
        engine.forceLoad(accessMatrixTemplate);
        builder.append(accessMatrixTemplate.getName()).append("(X");
        ...
        code = code.replace("<ACCESS_CALL>", builder.toString());
