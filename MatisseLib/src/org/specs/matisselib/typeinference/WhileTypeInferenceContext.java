...
public class WhileTypeInferenceContext extends ChildTypeInferenceContext {
    ...
    public WhileTypeInferenceContext(TypeInferenceContext parentContext, LoopInformationSink loopSink,
