...
public class ComputePortionRule extends BasicPortionCounter<ComputePortionRule.Counter> {
    ...
    public double apply(SchedulePredictorContext context) {
        ...
        return counter.computation / (counter.computation + counter.memory);
    }
