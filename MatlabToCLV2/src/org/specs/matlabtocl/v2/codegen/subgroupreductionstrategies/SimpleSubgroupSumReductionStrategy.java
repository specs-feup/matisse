...
public class SimpleSubgroupSumReductionStrategy extends ReductionStrategy {
    @Override
    public CInstructionList buildReductionOperation(ReductionComputation reductionComputation,
        ...
        body.addLiteralInstruction(builder.getSubGroupBarrierCode());
        ...
        CNode subgroupSizeNode = builder.getSubGroupSizeNode();
        ...
        InstanceProvider localGetProvider = ((MatrixType) localBuffer.getVariableType())
                .functions()
                .get();
        CNode subgroupLocalIdNode = builder.getSubGroupLocalIdNode();
        CNode subgroupIdNode = builder.getSubGroupIdNode();
        CNode indexOffset = FunctionInstanceUtils.getFunctionCall(
                CLBinaryOperator.MULTIPLICATION,
                providerData,
                subgroupIdNode,
                subgroupSizeNode);
        CNode index = FunctionInstanceUtils.getFunctionCall(
