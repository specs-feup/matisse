...
public class PhiSimplificationTests {
    @Test
    public void testBranch() {
        runTest(PhiSimplificationResource.BRANCH);
    }

    @Test
    public void testFor() {
        runTest(PhiSimplificationResource.FOR);
    }

    private static void runTest(PhiSimplificationResource resource) {
