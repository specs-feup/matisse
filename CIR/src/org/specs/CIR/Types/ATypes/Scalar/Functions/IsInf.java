...
public class IsInf extends AInstanceBuilder {

    public IsInf(ProviderData data) {
	super(data);
    }
	...
	String functionName = "isinf_" + scalarType.getSmallId();
	...
	return new GenericInstanceProvider(checker, data -> new IsInf(data).create());
    }
}
