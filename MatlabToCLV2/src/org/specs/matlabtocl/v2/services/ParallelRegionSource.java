...
/**
 * @see ParallelRegionCollection
 * @see InvokeParallelFunctionImplementationPass#PARALLEL_REGION_SOURCE
 *
 */
public interface ParallelRegionSource {
	public ParallelRegionInstance getById(ParallelRegionId id);
}
