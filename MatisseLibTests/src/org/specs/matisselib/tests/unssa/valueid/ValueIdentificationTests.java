...
package org.specs.matisselib.tests.unssa.valueid;
...
import org.specs.matisselib.unssa.ValueIdentification;
import org.specs.matisselib.unssa.ValueIdentificationBuilder;

import pt.up.fe.specs.util.SpecsIo;

public class ValueIdentificationTests {
    @Test
    public void testSimple() {
        runTest(ValueIdentificationResource.SIMPLE);
    }

    @Test
    public void testFor() {
        runTest(ValueIdentificationResource.FOR);
    }

    private static void runTest(ValueIdentificationResource resource) {
        ...
        ValueIdentification valueIdentification = ValueIdentificationBuilder.build(body, cfg);

        String expected = TestUtils.normalize(SpecsIo.getResource(resource.getExpectedResource()));
        String actual = TestUtils.normalize(valueIdentification.toString());
