...
for j1 = 1:n2,
	for i1 = 1:n1,
		...
		%JOAO: Outlining of inlined functions that spawn multiple lines
		%JOAO: Disabled outlining because inlining currently is only supported if the input of min is a variable
		%temp = min([D(i1, j1)+Repl D(i1+1, j1)+ ...
