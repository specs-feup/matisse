...
public class SizedMatrixData implements InstanceProvider {

    @Override
    public FunctionInstance newCInstance(ProviderData data) {
	String functionName = "$sized_matrix_data$" + data.getInputTypes().get(0).getSmallId();
	...
	return FunctionTypeBuilder.newInline()
		.addInput(inputType)
		.returning(inputType.getUnderlyingRawMatrixType())
		.build();
    }
