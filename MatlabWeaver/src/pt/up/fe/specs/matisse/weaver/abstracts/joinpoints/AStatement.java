 ...
 */
public abstract class AStatement extends AMWeaverJoinPoint {
     ...
     * @return the attribute's value
     */
    public abstract Boolean getDisplayImpl();
    ...
    public final Object getDisplay() {
        try {
        	if(hasListeners()) {
        		eventTrigger().triggerAttribute(Stage.BEGIN, this, "display", Optional.empty());
        	}
        	Boolean result = this.getDisplayImpl();
        	if(hasListeners()) {
        		eventTrigger().triggerAttribute(Stage.END, this, "display", Optional.ofNullable(result));
        	}
        	return result!=null?result:getUndefinedValue();
        } catch(Exception e) {
        	throw new AttributeException(get_class(), "display", e);
        }
    }
