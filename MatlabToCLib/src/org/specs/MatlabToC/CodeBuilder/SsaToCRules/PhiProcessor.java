...
public class PhiProcessor implements SsaToCRule {
	...
	// The phi instructions have been handled by the insertion of parallel copies and all
	// SSA variables in a phi are assigned to the same "final" variable.
    }
