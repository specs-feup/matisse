...
public class AssumeMatrixIndicesInRangeDirectiveInstructionRule implements TypeInferenceRule {

	@Override
	public boolean accepts(SsaInstruction instruction) {
		return instruction instanceof AssumeMatrixIndicesInRangeDirectiveInstruction;
	}
	...
	public void inferTypes(TypeInferenceContext context,
		...
		context.addFunctionProperty(new AssumeMatrixIndicesInRangeProperty());
	}
