 ...
 *
 */
public class CellSetInstruction extends ControlFlowIndependentInstruction {
    ...
    public CellSetInstruction(String outputMatrix, String inputMatrix, List<String> indices, String value) {
    ...
    @Override
    public CellSetInstruction copy() {
	return new CellSetInstruction(this.outputMatrix, this.inputMatrix, this.indices, this.value);
    }
	...
	return this.outputMatrix + " = cell_set " +
		this.inputMatrix + ", " +
