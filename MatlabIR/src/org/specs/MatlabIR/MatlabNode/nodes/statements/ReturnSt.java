 ...
 *
 */
public class ReturnSt extends ReservedWordSt {

    ReturnSt(StatementData data, Collection<MatlabNode> children) {
	super(data, children);
    }

    ReturnSt(int lineNumber) {
	super(new StatementData(lineNumber, false), Collections.emptyList());
    }

    @Override
    protected MatlabNode copyPrivate() {
	return new ReturnSt(getData(), Collections.emptyList());
    }
