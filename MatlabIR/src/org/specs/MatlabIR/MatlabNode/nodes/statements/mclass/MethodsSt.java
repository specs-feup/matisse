 ...
 *
 */
public class MethodsSt extends ClassBlockHeaderSt {
     ...
     * @param children
     */
    public MethodsSt(StatementData data, Collection<MatlabNode> children) {
	super(data, children);
    }

    public MethodsSt(int lineNumber, Collection<MatlabNode> children) {
	super(new StatementData(lineNumber, true), children);
    }

    @Override
    protected MatlabNode copyPrivate() {
	return new MethodsSt(getData(), Collections.emptyList());
    }
