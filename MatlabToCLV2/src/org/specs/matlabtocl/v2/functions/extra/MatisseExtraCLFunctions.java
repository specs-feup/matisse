...
public enum MatisseExtraCLFunctions implements MatlabFunctionProviderEnum {
    MATISSE_cl_global_id("MATISSE_cl_global_id") {
        @Override
        public List<InstanceProvider> getProviders() {
            return Arrays.asList(CLBuiltinPositioningFunction.GET_GLOBAL_ID);
        }
    };
    private final String functionName;

    private MatisseExtraCLFunctions(String functionName) {
