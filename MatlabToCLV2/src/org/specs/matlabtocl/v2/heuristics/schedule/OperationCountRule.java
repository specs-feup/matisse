...
public class OperationCountRule extends BasicPortionCounter<OperationCountRule.Counter> {
    ...
    protected boolean countInstruction(SchedulePredictorContext context,
        ...
        if (instruction.getInstructionType() == InstructionType.DECORATOR ||
            ...
            // These instructions have no impact on the cost of the function
            return false;
        }

        counter.operations += factor;
