...
package org.specs.MatlabProcessor.ifs;
...
public class IfStatementTest extends TestCase {
	...
	for (IfStatementTestResource resource : IfStatementTestResource.values()) {
	...
	for (StatementNode statement : block.getChildren(StatementNode.class)) {
	    if (statement instanceof IfSt) {
		output.append("Condition: ");
		output.append(((IfSt) statement).getExpression().getCode());
		output.append("\nBody: ");
	    } else if (statement instanceof ElseIfSt) {
		output.append("Elseif Condition: ");
		output.append(((ElseIfSt) statement).getExpression().getCode());
		output.append("\nBody: ");
	    } else if (statement instanceof ElseSt) {
		output.append("Else: ");
	    } else {
