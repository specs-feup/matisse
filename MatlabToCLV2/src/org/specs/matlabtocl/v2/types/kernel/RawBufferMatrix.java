...
public class RawBufferMatrix extends AMatrix {

    private final RawBufferMatrixType type;

    public RawBufferMatrix(RawBufferMatrixType type) {
	this.type = type;
    }
    ...
    @Override
    public RawBufferMatrixFunctions functions() {
	// TODO Auto-generated method stub
	return new RawBufferMatrixFunctions();
    }
