...
public class NativeLocalSumReductionStrategy extends ReductionStrategy {
    @Override
    public CInstructionList buildReductionOperation(ReductionComputation reductionComputation,
        ...
        body.addAssignment(partialValue,
                FunctionInstanceUtils.getFunctionCall(CLGroupReduceFunction.WORK_GROUP_REDUCE_ADD, providerData,
                        partialValue));
