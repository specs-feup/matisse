...
public class ResetKernelCollection implements PostCodeGenAction {
    private static final long serialVersionUID = 1L;

    private final KernelInstanceCollection kernelCollection;

    public ResetKernelCollection(KernelInstanceCollection kernelCollection) {
	this.kernelCollection = kernelCollection;
    }

    @Override
    public void run(File outputFolder) {
	this.kernelCollection.clearKernels();
    }
}
