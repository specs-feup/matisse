...
package org.specs.matisselib.tests.ast.operatorreplacement;
...
public class OperatorReplacementTests {
    @Test
    public void testSimple() {
	test(OperatorReplacementResource.SIMPLE);
    }

    @Test
    public void testConditional() {
	test(OperatorReplacementResource.CONDITIONAL);
    }

    private static void test(OperatorReplacementResource resource) {
	...
	String obtained = new OperatorReplacementPass().apply(parser.parse(resource), passData).getCode();
